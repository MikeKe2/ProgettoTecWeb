		...
		$.ajax({ //get della storia dal server 
			url:"/stories/"+$("#user").html()+"/"+$("#visibility").html()+"/"+$("#name").html(),
		 	success: (data)=>{
				...
				$("#all").click(function(){board.PopulateMenu("all");}); //setup del pulsante del filtro tutti sul menù destro delle scene 
				$("#notLoaded").click(function(){board.PopulateMenu("notLoaded");}); //setup del pulsante del filtro non caricate sul menù destro delle scene 
				$("#loaded").click(function(){board.PopulateMenu("loaded");}); //setup del pulsante del filtro caricate sul menù destro delle scene 
				$(".miniNav .listItem").click(function(){$(".miniNav .listItem").not(this).removeClass("attivato"); $(this).addClass("attivato");}) //setup della funzione che evidenzia il filtro scelto al click
